...
const SurveyApp = {
    ...
    handleMentalFollowUp(value) {
        ...
        if (value === 'social_worker' || value === 'psychologist') {
            this.addBotMessage('💬 خیلی خوب 🌼\nمی‌تونی با شماره‌ی موسسه 021-88738024-26 تماس بگیری تا هماهنگ کنیم صحبت کنی.');
        }
        ...
        if (value === 'sad') {
            ...
            this.addOptions([
                ...
                if (val === 'social_worker' || val === 'psychologist') {
                    this.addBotMessage('💬 می‌تونی با شماره‌ی موسسه 021-88738024-26 تماس بگیری تا هماهنگ کنیم صحبت کنی.');
                }
